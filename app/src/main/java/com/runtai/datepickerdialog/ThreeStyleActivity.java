 ...
 * @描述：自定义日期时间选择器
 */
public class ThreeStyleActivity extends FragmentActivity implements OnDateSetListener, OnTimeSetListener {
    ...
    public void onDateSet(DatePickerDialog datePickerDialog, int year, int month, int day) {
        Toast.makeText(ThreeStyleActivity.this, "new date:" + year + "-" + month + "-" + day, Toast.LENGTH_LONG).show();
    }
    ...
    public void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute) {
        Toast.makeText(ThreeStyleActivity.this, "new time:" + hourOfDay + "-" + minute, Toast.LENGTH_LONG).show();
    }
}