package com.runtai.datetimepickerlib;
...
import com.runtai.datetimepickerlib.R;
import com.runtai.datetimepickerlib.ScreenInfo;
import com.runtai.datetimepickerlib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
    ...
    public TimePopupWindow(Context context, Type type) {
        ...
        //指定PopupWindow的进场退场动画(从哪个方向)
        this.setAnimationStyle(R.style.timepopwindow_anim_style);

        rootView = LayoutInflater.from(context).inflate(R.layout.pw_time, null);
        // -----确定和取消按钮
